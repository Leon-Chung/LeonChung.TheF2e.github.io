import deskTop from "./deskTop.scss";
import phone from "./phone.scss";
...
let countDownDay = new Date("2022/11/07 11:59:59").getTime();
...
let countDown = setInterval(function(){
  ...
  if(time<0){
    clearInterval(countDownDay);//停止計時器，可以呼叫clearInterval()
    time.innerHTML = `Stop Registration`;
  }
